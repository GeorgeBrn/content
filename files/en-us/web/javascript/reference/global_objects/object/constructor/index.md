...
The **`constructor`** property contains a reference to the constructor function which will become the prototype of the instances it creates. The constructor property is placed inside the [[prototype]] property of the object we are viewing.
