...
The **`constructor`** property contains a refference to the constructor function which will become the prototype of the instances it creates. The constructor property is placed inside the [[prototype]] of the object we are viewing.
